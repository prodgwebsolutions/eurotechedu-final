...
const metadata = {
    ...
    keywords: 'Study abroad, MBBS abroad, Engineering abroad, MBA abroad, PhD abroad, overseas education consultant, top destinations, USA, UK, Germany, Australia, New Zealand, Dubai, Eurotechedu',
    robots: 'index, follow',
    openGraph: {
        type: 'website',
        url: 'https://eurotechedu.com',
        title: 'Eurotechedu - Your Global Education Partner',
        description: 'Transform your future with expert guidance for studying abroad. Over 500+ successful placements in premier institutions worldwide.',
        siteName: 'Eurotechedu',
        images: [
            {
                url: '/og-image.jpg'
            }
    ...
    twitter: {
        ...
        title: 'Eurotechedu - Study Abroad',
        description: 'Expert guidance for MBBS, Engineering, MBA & PhD programs globally.',
        images: [
            '/og-image.jpg'
        ]
    },
