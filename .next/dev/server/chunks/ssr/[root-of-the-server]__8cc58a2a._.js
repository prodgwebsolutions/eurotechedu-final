...
;
const metadata = {
    title: 'Eurotechedu - Study Abroad | MBBS | Engineering | MBA | PhD',
    description: 'Study abroad in USA, UK, Germany, Australia, New Zealand & Dubai. Expert guidance for MBBS, Engineering, MBA & PhD programs. Trusted since establishing excellence in international education.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
