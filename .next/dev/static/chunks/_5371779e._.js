...
function AdminPage() {
    ...
    const fetchLeads = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPage.useCallback[fetchLeads]": async ()=>{
            try {
    ...
    }["AdminPage.useCallback[fetchLeads]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            fetchLeads();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            const timer = setInterval({
                "AdminPage.useEffect.timer": ()=>setCountdown({
                        "AdminPage.useEffect.timer": (c)=>c > 0 ? c - 1 : 5
                    }["AdminPage.useEffect.timer"])
            }["AdminPage.useEffect.timer"], 1000);
            return ({
                "AdminPage.useEffect": ()=>clearInterval(timer)
            })["AdminPage.useEffect"];
        }
    }["AdminPage.useEffect"], []);
    const patchLead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPage.useCallback[patchLead]": async (rowNumber, patch)=>{
            setLeads({
                "AdminPage.useCallback[patchLead]": (prev)=>prev.map({
                        "AdminPage.useCallback[patchLead]": (l)=>l._rowNumber === rowNumber ? {
                                ...l,
                                ...patch.status ? {
                                    Status: patch.status
                                } : {},
                    ...
                    }["AdminPage.useCallback[patchLead]"])
            }["AdminPage.useCallback[patchLead]"]);
    ...
    const saveStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPage.useCallback[saveStatus]": (rowNumber, status)=>patchLead(rowNumber, {
                status
            })
    }["AdminPage.useCallback[saveStatus]"], [
        patchLead
    ]);
    const saveNotes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPage.useCallback[saveNotes]": (rowNumber, notes)=>patchLead(rowNumber, {
                notes
            })
    }["AdminPage.useCallback[saveNotes]"], [
        patchLead
    ]);
...
_s2(AdminPage, "0ShxuYBS7LYQyboymVZINKtsgkY=");
_c5 = AdminPage;
...
__turbopack_context__.k.register(_c3, "NotesCell");
__turbopack_context__.k.register(_c4, "StatusSelect");
